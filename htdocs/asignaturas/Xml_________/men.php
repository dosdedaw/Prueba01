...
<body>
	...
	<ul>
		<li>1<sup>er</sup> trimestre</li>
			<ul>
				<li><a href='?pags=./asignaturas/Xml_________/basico.html' >Básico</a></li>
				<li><a href='?pags=./asignaturas/Xml_________/basico00.html' >Básico 01</a></li>
			</ul>   
	

		<li>2<sup>o</sup> trimestre</li>


		<li>3<sup>er</sup> trimestre</li>
